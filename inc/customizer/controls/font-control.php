...
if ( class_exists( 'WP_Customize_Control' ) ) :
	 ...
	 */
	class GT_Office_Customize_Font_Control extends WP_Customize_Control {
		 ...
		 * @var string
		 */
		public $type = 'gt_office_custom_font';
		...
		public function __construct( $manager, $id, $args = array() ) {
			...
			$this->l10n = array(
				'previous' => esc_html__( 'Previous Font', 'gt-office' ),
				'next'     => esc_html__( 'Next Font', 'gt-office' ),
				'standard' => esc_html_x( 'Default', 'default font button', 'gt-office' ),
			);

			// Set Fonts.
			$this->fonts = GT_Office_Custom_Fonts::get_available_fonts();
