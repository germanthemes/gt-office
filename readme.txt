...
Theme URI: https://germanthemes.de/en/themes/gt-office/
...
GT Office is a next generation theme built for the Gutenberg Block Editor.

== Description ==

GT Office is a stunning and elegant theme built for the new WordPress Block Editor. It comes with great typography and colors and is packed with features, including social icons, a header search, multiple widget areas and several page templates.

For more information about GT Office please go to https://germanthemes.de/en/themes/gt-office/

== Installation ==

1. In your admin panel, go to Appearance -> Themes and click the 'Add New' button.
2. Click on the 'Upload Theme' button to upload the ZIP-file of the theme.
3. Go to https://germanthemes.de/en/docs/gt-office-documentation/ for a guide on how to use and customize this theme.
...
GT Office WordPress Theme, Copyright 2020 GermanThemes.de
GT Office is distributed under the terms of the GNU GPL
...
GT Office uses and bundles the following third-party resources:
